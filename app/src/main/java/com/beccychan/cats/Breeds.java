...
public class Breeds
{
    ...
    public void setAffection_level (String affection_level)
    {
    ...
    {
        return "ClassPojo [suppressed_tail = "+suppressed_tail+", wikipedia_url = "+wikipedia_url+", origin = "+origin+", description = "+description+", experimental = "+experimental+", life_span = "+life_span+", cfa_url = "+cfa_url+", rare = "+rare+", country_codes = "+country_codes+", lap = "+lap+", id = "+id+", short_legs = "+short_legs+", shedding_level = "+shedding_level+", dog_friendly = "+dog_friendly+", natural = "+natural+", rex = "+rex+", health_issues = "+health_issues+", hairless = "+hairless+", weight = "+weight+", alt_names = "+alt_names+", adaptability = "+adaptability+", vocalisation = "+vocalisation+", intelligence = "+intelligence+", social_needs = "+social_needs+", country_code = "+country_code+", child_friendly = "+child_friendly+", temperament = "+temperament+", vcahospitals_url = "+vcahospitals_url+", grooming = "+grooming+", hypoallergenic = "+hypoallergenic+", name = "+name+", vetstreet_url = "+vetstreet_url+", indoor = "+indoor+", energy_level = "+energy_level+", stranger_friendly = "+stranger_friendly+", affection_level = "+affection_level+"]";
    }
}
